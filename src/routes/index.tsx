...
import { Briefcase, Code, GraduationCap, Wrench } from 'lucide-react'
import { Button, Card, Text, Title, Badge, Group, Stack, Container, SimpleGrid, ThemeIcon, List, ListItem } from '@mantine/core'
...
function App() {
  return (
    <Container size="lg" py="xl" className="page-wrap">
      {/* Hero Section */}
      <Card radius="xl" p={{ base: 'xl', sm: 40 }} className="island-shell rise-in relative overflow-hidden" mb="xl">
        <Stack align="flex-start" gap="md" pos="relative" style={{ zIndex: 1 }}>
          <Text tt="uppercase" fw={700} lts="0.16em" size="xs" c="var(--kicker)" className="island-kicker m-0">Software Engineer</Text>
          <Title order={1} className="display-title m-0" c="var(--sea-ink)" style={{ fontSize: 'clamp(2.5rem, 5vw, 4rem)', lineHeight: 1.05 }}>
            Anthony Larson
          </Title>
          <Group gap="sm" mb="xs">
            <Badge variant="light" color="blue" size="lg" radius="sm">West Des Moines, IA</Badge>
          </Group>
          <Text size="lg" c="var(--sea-ink-soft)" maw={800} className="m-0" lh={1.6}>
            Tech Lead with proven experience in modernization, architecture, and mentorship. Always learning and growing, open to working in any programming language or environment.
          </Text>
          <Group mt="md">
            <Button
              component="a"
        ...
        <Stack className="md:col-span-2" gap="xl">
          ...
          <section id="experience" className="scroll-mt-24">
            <Group mb="xl">
              ...
              <Title order={2} c="var(--sea-ink)">Work Experience</Title>
            </Group>
            ...
            <Stack gap="xl">
              {[
                ...
                >
                  ...
                  <List size="sm" c="var(--sea-ink-soft)" spacing="xs" className="leading-relaxed">
        ...
        <Stack gap="xl">
          ...
          <section id="skills" className="scroll-mt-24">
            <Group mb="xl">
              ...
              <Title order={2} c="var(--sea-ink)">Skills</Title>
            </Group>

            <Card shadow="sm" radius="lg" className="island-shell rise-in" p="xl">
              <Group gap="xs">
                {['AWS', 'Azure', 'RabbitMQ', 'Kubernetes', 'Docker', 'React', 'JavaScript', 'MongoDB', 'NodeJS', 'TypeScript', 'C#', '.NET', 'SQL', 'Python'].map(skill => (
                  <Badge key={skill} variant="light" color="blue" size="lg" radius="sm">
                    {skill}
                  </Badge>
                ))}
              </Group>
          ...
          <section id="education" className="scroll-mt-24">
            <Group mb="xl">
              ...
              <Title order={2} c="var(--sea-ink)">Education</Title>
            </Group>
